  ...
  'react-router-dom'; class Featured extends Component { render() { return (
  <div >
  ...
  <h1> An interview with <mark className="second">Simon Parton</mark> from
  Swansea Music Hub </h1>

  <figure>
  <img src="https://lh3.google.com/u/1/d/0B5D2Zu8Epc5pRXhQLVJldkh2TmNJOXFNc0ZkUWFrZWdoSlE0=w2336-h1248-iv1"
  alt="Simon Parton from Swansea Music Hub" height="512px" width ="340px">
  </img>
  </figure>
    ...
    and arts, but as we are both musicians there was a big focus on music.  I
    think one of the most useful things that we learnt from the event is that
    ...
    over the internet and linking up with artists and musicians that we’ve met
    through the music scene. More recently I’ve been discovering lots of new
    music through organising our music directory on the site and it’s been great
    to reach out to artists to get creative and collaborate with them.</p>
    ...
    <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          <img className="d-block w-100" src="https://lh3.google.com/u/1/d/0B5D2Zu8Epc5pNEVuYldnc1BUR0owN2d0WnZ5TERwN3pTNzRz=w1912-h1528-iv1" alt="Trampolene">
        </img></div>
        <div className="carousel-item">
          <img className="d-block w-100" src="https://lh3.google.com/u/1/d/0B5D2Zu8Epc5pdXNmZ3M2RFV6bUpORjRNZHRJU2dmMWdSX3RZ=w2176-h1472-iv1" alt="Rachel K. Collier">
        </img></div>
        <div className="carousel-item">
          <img className="d-block w-100" src="https://lh3.google.com/u/1/d/0B5D2Zu8Epc5pV0RseU5qU2FPbW5kUHljZEl0Z1hjYTktdEJn=w2176-h1472-iv1" alt="Afro Cluster">
        </img></div>
      </div>
    ...
    <h2> Go to other bands/musicians’ gigs. Visit venues that you haven’t been to
    before. It’ll all come full circle and you’ll find that more people will
    support you! <strong>#SwanseaMusic</strong> </h2>
    ...
    musicians, artists and venues, but also a huge potential for audiences (both
    ...
    different parts of Swansea and genres all in one place is great and opens
    dialogue between artists that may never have made contact before. This was
    true at our musician’s forum earlier this month - we had people from the
    ...
    the directory, new gigs and reaching out to artists to let us know about any
    ...
    opportunities can be shared and a place where musicians can come together to
    improve our music scene. We’re hoping that this will not only bring new
...
<figure>
    ...
    <p>But, more importantly, support each other. Go to other bands/musicians’
